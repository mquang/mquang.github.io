...
var dayHasAudio = [...Array(164-152)].map((_, i) => 152 + i * 1);
var nonConsecutiveArr = [165,167,168,169,173,177,179,181,182,183,184,186,187,189,191,
...
// the time limit, in minutes
 QUIZ_TIME_LIMIT = roundHalf(rows*10/60) + 20/60;  
  ...
  var imgGifts = [1,7,11,12,13,14,15,21,22,23,24,25,26,27,29,30,32,34,
  35,36,37,39,47,49,51,58,62,74,75,76,77,82,83,86,87,
  93,98,102,103,106,107,108,109,110,114,117,121,129,
  133,134,136,140,141,142,143,146,148,150,151,156,157,160,161,163,
  169,175];
  ...
  function reset() {
    ...
    if (grand == 124){
      $('div.gallery').replaceWith('<div class="gallery" style="display:none"><figure><figcaption>'+praise+' <span class="glyphicon glyphicon-heart" style="color: #c90a0a;font-size: 25px;"></span> <small>Stay patient and keep up the good work.</small></figcaption><video id="gift" controls loop><source src="../gift2/3.mp4" type="video/mp4"></video></figure></div>');
    } else if(imgGifts.includes(grand)) {
      $('div.gallery').replaceWith('<div class="gallery" style="display:none"><figure><figcaption>'+praise+' <span class="glyphicon glyphicon-heart" style="color: #c90a0a;font-size: 25px;"></span> <small>Stay patient and keep up the good work.</small></figcaption><img id="gImg" src="../gift2/'+grand+'.jpg"/></figure></div>');
    } else{
      $('div.gallery').replaceWith('<div class="gallery" style="display:none"><figure><figcaption>'+praise+' <span class="glyphicon glyphicon-heart" style="color: #c90a0a;font-size: 25px;"></span> <small>Stay patient and keep up the good work.</small></figcaption><video id="gift" controls loop><source src="../gift2/'+grand+'.mp4" type="video/mp4"></video></figure></div>');
    }
...
if(imgGifts.includes(grand)) {
  $('body').append('<div class="gallery" style="display:none"><figure><figcaption>'+praise+' <span class="glyphicon glyphicon-heart" style="color: #c90a0a;font-size: 25px;"></span> <small>Stay patient and keep up the good work.</small></figcaption><img id="gImg" src="../gift2/'+grand+'.jpg"/></figure></div>');
}else{
  $('body').append('<div class="gallery" style="display:none"><figure><figcaption>'+praise+' <span class="glyphicon glyphicon-heart" style="color: #c90a0a;font-size: 25px;"></span> <small>Stay patient and keep up the good work.</small></figcaption><video id="gift" controls loop><source src="../gift2/'+grand+'.mp4" type="video/mp4"></video></figure></div>');
}
